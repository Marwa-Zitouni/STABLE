    ...
    public void update(Observable o, Object arg) {
      ...
      if (rdfTable.size()==0)
        ...
        rdfTable.stream().forEach((t) -> {
          System.out.println(t.get(0) + " and " + t.get(1) + " are involved in situation " + situationName + ' ' +t.get(2) );
          // System.out.println(t.get(0) + " and " + t.get(1) + " are involved in situation " + situationName + ' ' +t.get(2) + ' ' + t.get(3) + ' ' + t.get(4) );
...
//           OWLClass Anomaly = factory.getOWLClass(IRI.create(baseUri + "Anomaly"));
//           OWLIndividual anomalyInstance  = factory.getOWLNamedIndividual(IRI.create(baseUri,situationName + "-" + System.currentTimeMillis()));
//           OWLClassAssertionAxiom anomalyType = factory.getOWLClassAssertionAxiom(Anomaly, anomalyInstance );
//           ontology.add(anomalyType);
